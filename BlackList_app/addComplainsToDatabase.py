...
class RegisterComplains:
    ...
    def registerComplains(self):
        ...
        db_cursor.execute("INSERT INTO BlackList_app_complaints (abuseDescription,links,anonymity,studentId) VALUES('"+self.description+"','"+self.links+"','"+self.anonimity+"','"+self.studentId+"')")
